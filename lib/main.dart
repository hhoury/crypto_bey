...
import './pages/new_order_screenshot_page.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      routes: {
        ...
        ManageAddressesPage.routeName: (context) => ManageAddressesPage(),
        MyAccountPage.routeName: (context) => MyAccountPage(),
        NewOrderConfirmationPage.routeName: (context) => NewOrderConfirmationPage(),
        NewOrderPage.routeName: (context) => NewOrderPage(),
        NewOrderScreenshotPage.routeName: (context) => NewOrderScreenshotPage(),
